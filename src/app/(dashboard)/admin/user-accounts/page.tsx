  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        description="جدول موحّد لطلاب وأولياء الأمور: البريد، الحالة، تغيير المرور، التعطيل، الحذف، والدخول كالمستخدم (impersonation) لمتابعة التجربة دون معرفة كلمة المرور."
      />
