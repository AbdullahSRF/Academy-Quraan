...
export default async function AdminSubscriptionsPage() {
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        title="الاشتراكات"
        description="أربع باقات ثابتة بالجنيه المصري فقط — تُزامَن مع قاعدة البيانات وتُحذف أي باقات قديمة تلقائيًا مع ترحيل اشتراكاتها إلى باقة 8 حصص حتى لا تنكسر الروابط. الربط بالطلاب والتقارير والمالية يعمل كما هو."
        actions={
